    ...
    public void click(View v){
        ...
        switch (v.getId()){
            case R.id.save:
                ...
                //기록하기 위한 파일 스트림 만들기
                //- close를 하지 않아도 자동으로 닫히도록 try()안에서 생성
            ...
            case R.id.read:
                try(FileInputStream fis = openFileInput("sample.txt")){
                    ...
                    editText.setText("파일이 존재하지 않습니다.");
                }
                break;
            case R.id.delete:
            ...
            case R.id.resource:
                ...
                break;
            case R.id.imagecopy:
                try(InputStream fis = getResources().openRawResource(R.raw.jimin);
                    //파일 쓸수 있는 거를 만든거다.
                    FileOutputStream fos = openFileOutput("jimin.jpg",Context.MODE_PRIVATE);
                ){
